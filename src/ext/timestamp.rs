...
pub(crate) const TYPE_NAME: &str = "$Timestamp";
pub(crate) const FIELD_SECONDS_NAME: &str = "seconds";
...
pub fn try_deserialize(buf: &[u8]) -> Result<Timestamp, DeError> {
    crate::ext::try_deserialize_ext(buf)?.try_into()
}
